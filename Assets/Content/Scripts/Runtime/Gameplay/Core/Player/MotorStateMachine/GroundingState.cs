...
{
    public class GroundingState : StateBase<string>
    {
        ...
        public GroundingState(ConfigProvider configProvider, IInputService inputService, ICameraService cameraService,
        ...
        {
            Debug.Log($"Entering {nameof(GroundingState)} state.");
        ...
        private void AddBob()
        {
            _motionController.SetBobDesiredPosition(new Vector2(0, -0.5f));
        }
    }
}

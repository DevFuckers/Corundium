    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                float3 nC = UnpackNormalScale(
                    SAMPLE_TEXTURE2D(_NormalMap, sampler_NormalMap, uvC), _NormalStrength * 0.5);
                ...
                float sssNdotL = saturate(dot(N, lightDir) * 0.5 + 0.5);
                float sssWrap = sssNdotL * saturate(dot(-V, lightDir) * 0.3 + 0.7);

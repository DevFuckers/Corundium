...
//     version 1.11.2
//     from Assets/_Project/CodeBase/Runtime/Application/Services/Input/Input.inputactions
//
...
public partial class @Input: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""ExitTransport"",
                    ""type"": ""Button"",
                    ""id"": ""fc9e6e13-53aa-4100-bc7f-b92f943ca8b3"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""d55f2958-684b-4993-87e2-5b370747e1f9"",
                    ""path"": ""<Keyboard>/g"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""ExitTransport"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                }
            ]
    ...
    ""controlSchemes"": []
        ...
        m_Gameplay_ExitTransport = m_Gameplay.FindAction("ExitTransport", throwIfNotFound: true);
        // Transport
    ...
    ~@Input()
    {
        ...
        UnityEngine.Debug.Assert(!m_Transport.enabled, "This will cause a leak and performance issues, Input.Transport.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_Emergency.enabled, "This will cause a leak and performance issues, Input.Emergency.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_Gameplay_ExitTransport;
    public struct GameplayActions
    {
        ...
        public InputAction @ExitTransport => m_Wrapper.m_Gameplay_ExitTransport;
        ...
        public void AddCallbacks(IGameplayActions instance)
        {
            ...
            @ExitTransport.started += instance.OnExitTransport;
            @ExitTransport.performed += instance.OnExitTransport;
            @ExitTransport.canceled += instance.OnExitTransport;
        }
    ...
    public interface IGameplayActions
    {
        ...
        void OnExitTransport(InputAction.CallbackContext context);
    }
